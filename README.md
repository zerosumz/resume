...
1.	경험
    1. JAVA
        1.	웹 어플리케이션 다수 개발경험.
		2. Spring, GoogleGuice 등의 ioc 컨테이너 사용
		3. MyBatis 등의 sql맵퍼 사용
		4. HTML에디터, 각종 시각화 개발경험
		5. TCP/IP 중계서버(신용카드 전문통신) 개발경험 (netty)
		6. EIP 구현체인 apache camel 대몬 서비스 개발경험
	2. JAVASCRIPT
	    1. React 개발경험 (4년)
...
* validinput.js
    * https://github.com/zerosumz/validForm
    * html form 을 검사하는 간단한 jquery 플러그인

* mobx-react-bootstrap-form
    * https://github.com/zerosumz/mobx-react-bootstrap-form
    * mobx 를 사용하는 전송용 폼 컴포넌트
